...
<!-- Change logo in <?=$us_url_root?>usersc/templates/<?=$settings->template?>/assets/functions/themenav.php on line 106-->
        <img src="<?= $us_url_root ?>users/images/logo.png" style="width: 150px;">
    </a>
...
<!-- Sidebar Message -->
    <div class="sidebar-card">
        ...
        <p class="text-center mb-2">Sidebar Message. Found in <?=$us_url_root?>usersc/templates/<?=$settings->template?>/assets/functions/themenav.php</p>
    </div> */
?>
</ul>
<?PHP
